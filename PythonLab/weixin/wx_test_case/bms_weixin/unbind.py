...
class mytest(unittest.TestCase):
	...
	def setUp(self):
        ...
        print 'http://%s:%d%s' %('192.168.14.203',8210,'/userMapping/unbind')
	...
	#测试用例名称必须包含test
	def testApi001(self):
		body='req={"weixinOpenId":"oPvJds124v4cZUwfQAaAXY9tdsmY"}'		
		res = commonPostMethod_req.post(body,"/userMapping/unbind")
		data = res.read()
		print data
		print	res.status
